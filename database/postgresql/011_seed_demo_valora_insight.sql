WITH org AS (
  INSERT INTO valora.organizations(name, public_name, slug, email, plan_id)
  ...
  INSERT INTO billing.subscriptions(organization_id, plan_id, status)
  SELECT id, 'professional', 'active' FROM org
  ON CONFLICT DO NOTHING
), form AS (
  INSERT INTO valora.forms(organization_id,name,description,category,time_min,scoring_method,status,is_global)
  ...
  INSERT INTO valora.form_dimensions(form_id,name,description,display_order,max_score)
  ...
  INSERT INTO valora.questions(form_id, dimension_id, text, type, weight, max_score, required, display_order)
  ...
  INSERT INTO valora.question_options(question_id,text,score,display_order)
  ...
  INSERT INTO valora.surveys(organization_id,form_id,title,description,status,token_hash,public_slug,public_url,starts_at,expires_at,is_free,is_featured,visible_on_home,allow_repeat,require_identification,lgpd_required)
...
INSERT INTO valora.survey_links(id, organization_id, survey_id, token_hash, public_url, status, expires_at)
