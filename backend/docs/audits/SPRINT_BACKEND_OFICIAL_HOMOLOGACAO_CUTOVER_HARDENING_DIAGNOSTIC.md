...
A base oficial está em `backend/database/postgresql`, com script completo e migração de importação. O ambiente local precisava de scripts padronizados para aplicar schema em PostgreSQL descartável.
