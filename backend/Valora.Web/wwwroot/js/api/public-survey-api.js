window.PublicSurveyApi={
  ...
  validate:(id,publicToken)=>AjaxClient.post(`/bff/public/surveys/${encodeURIComponent(id)}/validate`,publicToken?{publicToken,inviteToken:publicToken,token:publicToken}:{}),
