...
const missing=["buildValoraDifferentials","Por que esta leitura é diferente","Valora mostra sustentação"].filter(x=>!corpus.includes(x));
if(missing.length){console.error('Missing legacy validation markers for valora-differentials-premium:',missing.join(', '));process.exit(1);}
...
console.log('OK legacy valora-differentials-premium');
