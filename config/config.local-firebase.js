(function () {
  ...
  window.ValoraConfig = Object.freeze({
    ...
    API_BASE_URL: 'https://api.valoragroup.mnsoft.com.br', FIREBASE_ENABLED: true, FIREBASE_PLAN: 'spark', ENABLE_CLOUD_FUNCTIONS: false, REQUIRE_AUTH_SERVER_VALIDATION: false, LOCAL_API_ENABLED: false, LOCAL_API_BASE_URL: '', EMAIL_TRANSPORT: 'external-api', WHATSAPP_TRANSPORT: 'manual', EXTERNAL_API_BASE_URL: 'http://127.0.0.1:8097',
