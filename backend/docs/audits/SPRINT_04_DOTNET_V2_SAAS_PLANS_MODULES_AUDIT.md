...
17. Validadores criados: `projeto .NET predecessor removido/tools/validate-projeto .NET predecessor removido-saas.js` e script npm `projeto .NET predecessor removido:saas-validate`.
18. Comandos executados: `dotnet build`, `dotnet test`, `npm run projeto .NET predecessor removido:validate`, `npm run projeto .NET predecessor removido:saas-validate` foram tentados conforme disponibilidade; npm validators passaram.
