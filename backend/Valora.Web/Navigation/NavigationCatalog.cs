...
public sealed class NavigationCatalog
{
    ...
    [
        ...
        Section("intelligence", "Inteligência", 30,
            Item("intelligence.organizational", "Inteligência Organizacional", "Maturidade, confiança e evolução orientadas por evidências", "Intelligence", "chart-radar", "organizational_intelligence.read", "organizational_intelligence", "organizational_intelligence", "organization", 5, Results),
