...
public static class InfrastructureServiceCollectionExtensions
{
    public static IServiceCollection AddInfrastructureServices(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddScoped<IBenchmarkMetricRepository>(sp => sp.GetRequiredService<BenchmarkComparisonRepository>());
        services.AddScoped<IBenchmarkComparisonRepository>(sp => sp.GetRequiredService<BenchmarkComparisonRepository>());
        services.AddScoped<IBenchmarkInsightRepository>(sp => sp.GetRequiredService<BenchmarkComparisonRepository>());
