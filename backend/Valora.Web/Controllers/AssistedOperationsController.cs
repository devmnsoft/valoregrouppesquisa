...
public sealed class AssistedOperationsController : Controller
{
    ...
    [Route("ProductBacklog"), Route("Platform/ProductBacklog")] public IActionResult Backlog()=>Page("product-backlog","Backlog de Melhorias","Priorize evoluções preservando a origem e a rastreabilidade.");
