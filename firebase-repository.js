...
window.ValoraFirebaseRepository={
  ...
  listForms:loadForms,createForm(data){return callFunction('adminCreateForm',{payload:deepCleanForFirestore(data)}).catch(()=>createDoc('forms',data));},updateForm(id,data){return callFunction('adminUpdateForm',{id,payload:deepCleanForFirestore(data)}).catch(()=>updateDoc('forms',id,data));},deleteForm(id){return callFunction('adminDeleteForm',{id}).catch(()=>deleteDoc('forms',id));},adminCreateForm(data){return callFunction('adminCreateForm',{payload:deepCleanForFirestore(data)});},adminUpdateForm(id,data){return callFunction('adminUpdateForm',{id,payload:deepCleanForFirestore(data)});},adminDeleteForm(id){return callFunction('adminDeleteForm',{id});},adminCloneForm(id,changes){return callFunction('adminCloneForm',{formId:id,changes:deepCleanForFirestore(changes||{})});},adminCreateFormVersion(id,changes){return callFunction('adminCreateFormVersion',{formId:id,changes:deepCleanForFirestore(changes||{})});},
  listSurveys:loadSurveys,createSurvey(data){return callFunction('adminCreateSurvey',{payload:deepCleanForFirestore(data)}).catch(()=>createDoc('surveys',data));},updateSurvey(id,data){return callFunction('adminUpdateSurvey',{id,payload:deepCleanForFirestore(data)}).catch(()=>updateDoc('surveys',id,data));},deleteSurvey(id){return callFunction('adminDeleteSurvey',{id}).catch(()=>deleteDoc('surveys',id));},adminCreateSurvey(data){return callFunction('adminCreateSurvey',{payload:deepCleanForFirestore(data)});},adminUpdateSurvey(id,data){return callFunction('adminUpdateSurvey',{id,payload:deepCleanForFirestore(data)});},adminDeleteSurvey(id){return callFunction('adminDeleteSurvey',{id});},adminArchiveSurvey(id){return callFunction('adminArchiveSurvey',{id});},adminCloseSurvey(id){return callFunction('adminCloseSurvey',{id});},
