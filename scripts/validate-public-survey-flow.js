...
ok(/publicSubmission/.test(rt)&&/provider/.test(rt),'runtime sem publicSubmission.');
ok(/submitSurveyResponseViaGateway/.test(app)&&/submitSurveyResponseViaFirestoreClient/.test(app),'providers de submissão ausentes.');
