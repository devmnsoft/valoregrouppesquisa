INSERT INTO valorapesquisa.plans(id,name,badge,public_subtitle,description,price_label,price_complement,cta_label,display_order,highlight,recommended,visible_on_public_pricing,internal_only,status) VALUES
