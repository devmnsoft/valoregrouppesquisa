...
Antes de cutover, aplicar `scriptbd_completo.sql` validado pelo bloco `-- COMPATIBILIDADE PARA BANCOS EXISTENTES`, garantindo `plan_limits.users` e demais colunas antes dos seeds.
