...
public sealed class NavigationCatalog
{
    ...
    [
        ...
        Section("methodology", "Metodologia Valora", 25,
            ItemAction("methodology.overview", "Visão Metodológica", "Governança da base oficial versionada", "Methodology", "Overview", "sparkles", "organizational_intelligence", 1, Roles("admin_valora")),
            ItemAction("methodology.dimensions", "Dimensões", "Eixos oficiais de maturidade", "Methodology", "Dimensions", "layers", "organizational_intelligence", 2, Roles("admin_valora")),
            ItemAction("methodology.concepts", "Conceitos", "Dicionário Cognitivo Valora™", "Methodology", "Concepts", "file-text", "organizational_intelligence", 3, Roles("admin_valora")),
            ItemAction("methodology.map", "Mapa Cognitivo", "Relações e regras de interpretação", "Methodology", "CognitiveMap", "brain", "organizational_intelligence", 4, Roles("admin_valora")),
            ItemAction("methodology.questions", "Perguntas Oficiais", "Banco versionado e rastreável", "Methodology", "OfficialQuestions", "file-question", "forms", 5, Roles("admin_valora")),
            ItemAction("methodology.templates", "Templates", "Diagnósticos oficiais por público", "Methodology", "Templates", "layers", "forms", 6, Roles("admin_valora")),
            ...
            ItemAction("methodology.recommendations", "Recomendações", "Catálogo orientado por evidências", "Methodology", "Recommendations", "activity", "results", 8, Roles("admin_valora")),
            ItemAction("methodology.versions", "Versões", "Publicação e preservação histórica", "Methodology", "Versions", "shield", "organizational_intelligence", 9, Roles("admin_valora"))),
        Section("intelligence", "Desenvolvimento Organizacional", 30,
            ...
            ItemAction("intelligence.benchmark", "Benchmark", "Maturidade e posicionamento estratégico", "Intelligence", "Benchmark", "activity", "organizational_intelligence", 23, Results),
            ItemAction("intelligence.evolution", "Jornada de Evolução", "Marcos, ações e indicadores", "Evolution", "Index", "activity", "organizational_intelligence", 24, Results),
            ...
            ItemAction("intelligence.one-on-one", "One-on-One™", "Conversas e compromissos responsáveis", "OneOnOne", "Index", "users", "organizational_intelligence", 27, Results),
            ItemAction("intelligence.leadership", "Lideranças", "Desenvolvimento baseado em evidências", "Leadership", "Index", "users", "organizational_intelligence", 28, Results),
        ...
        Section("administration", "Administração", 40,
            ...
            ItemAction("administration.organizations", "Organizações", "Clientes, contexto e situação contratual", "Enterprise", "Organizations", "building", "organization", 1, Roles("admin_valora")),
