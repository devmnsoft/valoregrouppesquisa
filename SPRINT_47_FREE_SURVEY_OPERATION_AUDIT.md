...
Escopo auditado: `index.html`, `app.js`, `pdf.js`, `config.js`, `firebase.json`, `backend/Valora.Api/`, `backend/Valora.Application/`, `backend/Valora.Infrastructure/`, `backend/Valora.Web/`, `backend/database/postgresql/`, `scripts/`, `tests/`, `tests/e2e/` e `tests/e2e-web/`.
