...
## 10. Reaproveitamento conceitual de projeto .NET predecessor removido
Apenas conceitos de SaaS, módulos, planos, entitlement e relatórios podem orientar nomes e regras; nenhuma feature deve ser implementada em `projeto .NET predecessor removido`.
