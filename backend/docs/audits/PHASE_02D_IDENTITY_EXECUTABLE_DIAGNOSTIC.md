...
- SHA inicial: `5307f07143adcc9c08c31e6fcce85d9c462d8afc`.
...
|---|---|---|---|---|
| OrganizationRepository | organizations | document, plan_code, is_deleted | public_name, slug, deleted_at; plano em subscriptions | migration normaliza campos canônicos; repository ainda requer refatoração tipada |
| UserRepository | users | role, role_id, is_deleted, SELECT * | deleted_at e roles/user_roles | migration cria user_roles e índice global de e-mail; repository ainda requer refatoração tipada |
