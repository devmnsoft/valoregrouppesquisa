# Política sem resposta demonstrativa em produção

O termo técnico legado foi removido de scripts Windows; produção continua bloqueada contra respostas demonstrativas.
