...
window.ValoraFirebaseRepository={
  ...
  listForms:loadForms,createForm(data){return callFunction('adminCreateForm',{payload:deepCleanForFirestore(data)}).catch(()=>createDoc('forms',data));},updateForm(id,data){return callFunction('adminUpdateForm',{id,payload:deepCleanForFirestore(data)}).catch(()=>updateDoc('forms',id,data));},deleteForm(id){return callFunction('adminDeleteForm',{id});},adminGetFormUsage(id){return callFunction('adminGetFormUsage',{formId:typeof id==='object'?id.formId:id});},adminCloseSurveysByForm(id,mode='close'){return callFunction('adminCloseSurveysByForm',{formId:typeof id==='object'?id.formId:id,mode:typeof id==='object'?(id.mode||mode):mode});},adminCreateForm(data){return callFunction('adminCreateForm',{payload:deepCleanForFirestore(data)});},adminUpdateForm(id,data){return callFunction('adminUpdateForm',{id,payload:deepCleanForFirestore(data)});},adminDeleteForm(id){return callFunction('adminDeleteForm',{id});},adminCloneForm(id,changes){return callFunction('adminCloneForm',{formId:id,changes:deepCleanForFirestore(changes||{})});},adminCreateFormVersion(id,changes){return callFunction('adminCreateFormVersion',{formId:id,changes:deepCleanForFirestore(changes||{})});},repairOfficialFormDocument(){return callFunction('repairOfficialFormDocument',{});},
  listSurveys:loadSurveys,createSurvey(data){return callFunction('adminCreateSurvey',{payload:deepCleanForFirestore(data)}).catch(()=>createDoc('surveys',data));},updateSurvey(id,data){return callFunction('adminUpdateSurvey',{id,payload:deepCleanForFirestore(data)}).catch(()=>updateDoc('surveys',id,data));},deleteSurvey(id){return callFunction('adminDeleteSurvey',{id});},adminCreateSurvey(data){return callFunction('adminCreateSurvey',{payload:deepCleanForFirestore(data)});},adminUpdateSurvey(id,data){return callFunction('adminUpdateSurvey',{id,payload:deepCleanForFirestore(data)});},adminDeleteSurvey(id){return callFunction('adminDeleteSurvey',{id});},adminArchiveSurvey(id){return callFunction('adminArchiveSurvey',{id});},adminCloseSurvey(id){return callFunction('adminCloseSurvey',{id});},
