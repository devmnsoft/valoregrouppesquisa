...
UPDATE valorapesquisa.journey_events SET event_type='manual_note' WHERE event_type NOT IN('diagnostic_created','result_calculated','insight_generated','alert_generated','decision_created','action_created','action_completed','evolution_snapshot','report_generated','governance_meeting','cycle_closed','manual_note'); UPDATE valorapesquisa.journey_events SET impact_level='medium' WHERE impact_level NOT IN('critical','high','medium','low');
