...
const missing=["organizationalHealthSection","admin/organizational-health","Índice Valora de Maturidade"].filter(x=>!corpus.includes(x));
if(missing.length){console.error('Missing legacy validation markers for organizational-health-panel:',missing.join(', '));process.exit(1);}
...
console.log('OK legacy organizational-health-panel');
