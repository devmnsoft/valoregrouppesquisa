...
public sealed class GenerateBenchmarkSnapshotRequest {
    ...
    [Range(0, 100)] public decimal MaturityScore { get; init; }
    [Range(1, 1000000)] public int SampleSize { get; init; }
...
public sealed class BenchmarkComparisonRequest {
    ...
    [Required, StringLength(100)] public string Segment { get; init; } = "";
    [Required, StringLength(120)] public string Criterion { get; init; } = "maturity"; [Required] public DateOnly PeriodStart { get; init; }
    [Required] public DateOnly PeriodEnd { get; init; }
    [StringLength(120)] public string? Dimension { get; init; }
    [StringLength(120)] public string? Indicator { get; init; }
}
