...
public sealed class PublicCommercialController(PublicCommercialService service) : ControllerBase
{
    ...
    [AllowAnonymous, HttpPost("/api/v1/public/leads")]
    [AllowAnonymous, HttpPost("/api/v1/public/diagnostic/start")]
    ...
    [AllowAnonymous, HttpPost("/api/v1/public/contact-requests")]
    [AllowAnonymous, HttpPost("/api/v1/public/plan-interest")]
