...
Criada base paralela `projeto .NET predecessor removido`, preservando legado da raiz e `backend/Valora.sln`.

## 2. Estrutura criada
Solution, projetos `src/*`, testes e scripts PostgreSQL em `projeto .NET predecessor removido/backend/database/postgresql`.
