# Testes locais de compatibilidade do scriptbd_completo.sql
...
Execute cada arquivo em uma base descartável e depois rode `psql -U postgres -d postgres -f scriptbd_completo.sql` duas vezes.
