...
public static class ApplicationServiceCollectionExtensions {
    public static IServiceCollection AddApplicationServices(this IServiceCollection services) {
        ...
        services.AddScoped<ActionPlanService>(); services.AddScoped<ActionItemService>(); services.AddScoped<ActionProgressService>(); services.AddScoped<PriorityActionService>(); services.AddScoped<Valora.Application.ActionCenter.ActionRecommendationService>();
        services.AddScoped<GenerateActionPlanFromDiagnosticUseCase>(); services.AddScoped<CreateActionFromInsightUseCase>(); services.AddScoped<CreateActionFromAlertUseCase>(); services.AddScoped<CreateActionFromDecisionUseCase>(); services.AddScoped<UpdateActionProgressUseCase>(); services.AddScoped<CompleteActionUseCase>(); services.AddScoped<BlockActionUseCase>(); services.AddScoped<ResumeActionUseCase>();
