...
## 3. Diferença entre legado, backend, backend-v2 e scripts atuais
...
- `backend-v2`: referência histórica, sem novas features.
- Scripts SQL atuais: contrato oficial PostgreSQL em `scriptbd_completo.sql` e `database/postgresql/*.sql`, devendo ser compatíveis com o schema real.
