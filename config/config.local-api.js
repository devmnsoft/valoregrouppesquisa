(function () {
  ...
  window.ValoraConfig = Object.freeze({
    ...
    DATA_PROVIDER: 'api',
    ALLOW_API_PRODUCTION_CUTOVER: false, HYBRID_PRIMARY_PROVIDER: 'api', API_TIMEOUT_MS: 20000,
    API_BASE_URL: 'http://127.0.0.1:5080', EXTERNAL_API_BASE_URL: 'http://127.0.0.1:5080',
