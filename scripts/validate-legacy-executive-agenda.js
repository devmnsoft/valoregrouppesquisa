...
const missing=["buildExecutiveAgenda","Agenda executiva recomendada","writeExecutiveAgendaPdf"].filter(x=>!corpus.includes(x));
if(missing.length){console.error('Missing legacy validation markers for executive-agenda:',missing.join(', '));process.exit(1);}
...
console.log('OK legacy executive-agenda');
