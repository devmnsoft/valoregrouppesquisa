...
- Criado `database/postgresql/banco_completo.sql` como bootstrap canônico não destrutivo e idempotente.
...
- Script histórico `database/postgresql/scriptbd_completo.sql` como referência de estruturas e compatibilidade.
