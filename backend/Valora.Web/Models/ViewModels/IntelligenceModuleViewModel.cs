    ...
    IReadOnlyList<string> Capabilities)
{
    private static readonly IReadOnlyDictionary<string, IntelligenceModuleViewModel> Catalog =
        new[]
        {
            Module("evidence", "Evidências Organizacionais", "Rastreabilidade", "A origem verificável de toda leitura", "Respostas e sinais autorizados, normalizados e ligados a conceitos, métricas e índices sem expor participantes.", "evidence", "Insight", "Origem e diagnóstico", "Confiança e peso", "Conceito, métrica e índice"),
            ...
            Module("metrics", "Valora Metrics™", "Indicadores", "Métricas com contexto, não números isolados", "Indicadores oficiais com definição, fonte e rastreabilidade para evitar conclusões sem evidência.", "modules/metrics", "Insight", "Catálogo de indicadores", "Fonte e peso", "Leitura por capacidade"),
            Module("indices", "Índices Valora™", "Maturidade em contexto", "Doze índices oficiais em escala de 0 a 100", "IMO™, ICS™, IIO™, IGO™, ICO™, ILI™, IPO™, IDO™, IAC™, IAR™, IIS™ e ISO™ combinam consistência, recorrência, relações e evolução; não uma média isolada.", "modules/indices", "Professional", "Classificação de maturidade", "Fatores contribuintes", "Histórico e tendência"),
            Module("radar", "Valora Radar™", "Leitura multidimensional", "Equilíbrio organizacional em perspectiva", "Visualização das dimensões avaliadas no mesmo ciclo, sem transformar benchmark em ranking público.", "modules/radar", "Professional", "Radar por dimensão", "Gap estrutural", "Evidências agregadas"),
            ...
            Module("benchmark", "Valora Benchmark™", "Referência contextual", "Comparar para compreender, nunca para ranquear", "Comparação privada entre ciclos e recortes autorizados. Não há ranking público de organizações.", "modules/benchmark", "Professional", "Comparação entre ciclos", "Contexto da amostra", "Privacidade por padrão"),
            Module("insights", "Valora Insights IA™", "Motor de inferência", "Da observação ao plano de evolução", "Conclusões rastreáveis com observação, evidências, correlação, causa provável, impacto, prioridade e confiança.", "modules/insights", "Professional", "Hipóteses explícitas", "Confiança informada", "Regra de três evidências"),
            ...
            Module("executive-report", "Valora Executive Report™", "Governança executiva", "Uma narrativa verificável para a liderança", "Estrutura de devolutiva executiva baseada nos resultados disponíveis e nos limites da evidência.", "modules/executive-reports", "Professional", "Síntese executiva", "Riscos e prioridades", "Exportação preparada"),
            Module("one-on-one", "Valora One-on-One™", "Desenvolvimento responsável", "Conversas estruturadas sem expor respostas individuais", "Estrutura preparada para pautas e compromissos, preservando privacidade e finalidade organizacional.", "modules/one-on-one", "Enterprise", "Pauta estruturada", "Compromissos", "Privacidade individual"),
            Module("power-bi", "Power BI™", "Integrações", "Dados preparados para análise autorizada", "Camada de exportação preparada para datasets agregados; conexão externa não é simulada nesta fase.", "modules/integrations", "Enterprise", "Dataset agregado", "Dicionário de métricas", "Pronto para integração"),
            Module("platform-governance", "Governança da Plataforma", "Controle e rastreabilidade", "Governança técnica distinta da capacidade organizacional", "Trilhas de acesso, configurações, indicadores, diagnósticos, exportações e ciclos com escopo organizacional.", "modules/platform-governance", "Enterprise", "Trilha auditável", "Alterações sensíveis", "Governança de acesso")
