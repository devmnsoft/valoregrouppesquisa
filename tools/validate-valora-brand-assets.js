...
ok(read('scriptbd_completo.sql').includes('/img/brand/valora-logo-full.jpeg') || read('database/postgresql/scriptbd_completo.sql').includes('/img/brand/valora-logo-full.jpeg'), 'SQL não contém path da logo completa');
ok(read('scriptbd_completo.sql').includes('/img/brand/valora-symbol.jpeg') || read('database/postgresql/scriptbd_completo.sql').includes('/img/brand/valora-symbol.jpeg'), 'SQL não contém path do símbolo');
