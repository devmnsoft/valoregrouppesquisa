...
public sealed class ValoraIconRegistry
{
    ...
    private static readonly IReadOnlyDictionary<string, string> Icons = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["book-open"] = "<path d=\"M2 4h6a4 4 0 0 1 4 4v13a4 4 0 0 0-4-4H2V4Zm20 0h-6a4 4 0 0 0-4 4v13a4 4 0 0 1 4-4h6V4Z\"/>",
    ...
    public IReadOnlyCollection<string> KnownIcons => (IReadOnlyCollection<string>)Icons.Keys;
