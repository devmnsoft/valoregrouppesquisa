...
if not exist SPRINT_72_DEMO_LINK_PROVIDER_HOTFIX_AUDIT.md goto erro
echo LINK DEMO + PROVIDER_UNAVAILABLE CORRIGIDO.
pause
exit /b 0
:erro
echo FALHA NA CORRECAO LINK DEMO + PROVIDER_UNAVAILABLE.
pause
exit /b 1
