...
for(const code of ['SPARK_CLOUD_FUNCTIONS_PUBLIC_JOURNEY','API_PROVIDER_WITHOUT_BASE_URL','PUBLIC_SUBMISSION_EXTERNAL_API_WITHOUT_GATEWAY','CLOUD_FUNCTIONS_DISABLED_PUBLIC_PROVIDER']){
