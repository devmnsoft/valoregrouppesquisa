...
Consolidar entidades/SQL, repositories/services, controllers, Web MVC, menu, auditoria, testes estáticos, validador npm e documentação, sem alterar `projeto .NET predecessor removido` nem criar novo frontend.
