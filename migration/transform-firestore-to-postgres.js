...
migrationLogger.step('transform-firestore-to-postgres.js started');
...
migrationLogger.success('transform-firestore-to-postgres.js completed',{durationMs:done()});
}
main().catch(error=>{migrationLogger.fail('transform-firestore-to-postgres.js failed',{durationMs:0,error:migrationLogger.sanitize(error&&error.message||error)});process.exit(1);});
