(function () {
  ...
  window.ValoraConfig = Object.freeze({
    ...
    API_BASE_URL: 'http://127.0.0.1:8097', FIREBASE_ENABLED: true, FIREBASE_PLAN: 'spark', ENABLE_CLOUD_FUNCTIONS: false, REQUIRE_AUTH_SERVER_VALIDATION: false, LOCAL_API_ENABLED: false, LOCAL_API_BASE_URL: '', PUBLIC_SUBMISSION_PROVIDER: 'external-api', PUBLIC_SURVEY_VALIDATION_PROVIDER: 'external-api', RESULT_PROVIDER: 'external-api',
