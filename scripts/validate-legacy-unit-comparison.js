...
const missing=["unitComparisonSection","admin/unit-comparison","multipleUnits"].filter(x=>!corpus.includes(x));
if(missing.length){console.error('Missing legacy validation markers for unit-comparison:',missing.join(', '));process.exit(1);}
...
console.log('OK legacy unit-comparison');
