...
{id:'support',label:'Atendimento',description:'Central de tickets, SLA, base de conhecimento e atendimento humano.',scope:'empresa',requiredPermission:'canAccessPortal',defaultEnabled:true,commercialFeature:true,route:'empresa/support'},
...
{id:'integrations',label:'Integrações',description:'API pública, webhooks, importação/exportação e logs corporativos.',scope:'empresa',requiredPermission:'canViewReports',defaultEnabled:false,commercialFeature:true,route:'empresa/integrations'},
