...
- Validador de schema único passou a verificar `backend/database/postgresql`, `backend`, `migration` e `scripts`, ignorando falsos positivos de namespace C# `Valora.*`.
