(function(){
'use strict';
const ALL_TRUE={canAccessPortal:true,canManageCompanies:true,canManagePlans:true,canManageModules:true,canManageGlobalSettings:true,canManageCompanyUsers:true,canCreateForms:true,canCreateSurveys:true,canSendInvites:true,canViewResponses:true,canViewReports:true,canViewFinance:true,canViewLogs:true,canBackup:true,canAnswerSurveys:true,canHandleSupport:false,canHandleGlobalSupport:false,restrictedToDepartment:false};
const BASE={canAccessPortal:false,canManageCompanies:false,canManagePlans:false,canManageModules:false,canManageGlobalSettings:false,canManageCompanyUsers:false,canCreateForms:false,canCreateSurveys:false,canSendInvites:false,canViewResponses:false,canViewReports:false,canViewFinance:false,canViewLogs:false,canBackup:false,canAnswerSurveys:false,canHandleSupport:false,canHandleGlobalSupport:false,restrictedToDepartment:false};
const ROLE_DEFINITIONS={
 admin_valora:{...BASE,...ALL_TRUE,canHandleSupport:true,canHandleGlobalSupport:true,id:'admin_valora',label:'Administrador Geral Valora',scope:'valora',description:'Administra toda a plataforma Valora Insight: clientes, planos, módulos, usuários, financeiro, configurações, backup, logs e dados operacionais.'},
 consultor_valora:{...BASE,id:'consultor_valora',label:'Consultor Valora',scope:'valora',description:'Visualiza a operação Valora e acompanha clientes, formulários, pesquisas, respostas e relatórios sem alterar financeiro, planos, backup ou configurações críticas.',canAccessPortal:true,canManageCompanies:true,canViewResponses:true,canViewReports:true,canHandleGlobalSupport:true},
 empresa_admin:{...BASE,id:'empresa_admin',label:'Administrador da Empresa',scope:'empresa',description:'Administra usuários, funcionários, formulários, pesquisas, convites, respostas, relatórios, plano contratado e dados da própria empresa.',canAccessPortal:true,canManageCompanyUsers:true,canCreateForms:true,canCreateSurveys:true,canSendInvites:true,canViewResponses:true,canViewReports:true,canViewFinance:true,canAnswerSurveys:true,canHandleSupport:true},
