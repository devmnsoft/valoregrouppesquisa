...
- [x] `projeto .NET predecessor removido` documentado apenas como referência temporária.
...
## Aceite premium adicional
- [ ] `npm run web:premium-layout` passa.
- [ ] `npm run db:scriptbd-validate` passa.
- [ ] Home, admin, dashboard, resultado, certificado e diagnóstico foram homologados em desktop e mobile.
