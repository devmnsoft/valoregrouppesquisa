...
const missing=["buildEvolutionPlan90Days","Plano de evolução 30/60/90","writeEvolutionPlan90DaysPdf"].filter(x=>!corpus.includes(x));
if(missing.length){console.error('Missing legacy validation markers for evolution-plan-90-days:',missing.join(', '));process.exit(1);}
...
console.log('OK legacy evolution-plan-90-days');
