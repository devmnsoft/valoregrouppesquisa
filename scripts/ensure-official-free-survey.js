...
function printOfficialUrls(token){console.log(`https://valoragroup.mnsoft.com.br/?survey=${OFFICIAL_FREE_SURVEY_ID}&token=${token}&org=${OFFICIAL_FREE_ORG_SLUG}`);console.log(`https://gestordepesquisa.web.app/?survey=${OFFICIAL_FREE_SURVEY_ID}&token=${token}&org=${OFFICIAL_FREE_ORG_SLUG}`);}
