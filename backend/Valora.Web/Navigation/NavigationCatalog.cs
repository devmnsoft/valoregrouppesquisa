...
public sealed class NavigationCatalog
{
    ...
    [
        ...
        Section("diagnostics", "Diagnósticos", 20,
            ...
            Item("diagnostics.distribution", "Distribuição", "Gerencie links seguros", "/Distribution", "send", null, "surveys", "distribution", "organization", 30, Diagnostics),
        ...
        Section("intelligence", "Inteligência", 30,
            ...
            Item("intelligence.certificates", "Certificados", "Emissão e reimpressão", "/Certificates", "award", null, "certificates", "certificates", "organization", 20, Results)),
