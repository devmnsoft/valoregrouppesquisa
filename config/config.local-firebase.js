(function () {
  ...
  window.ValoraConfig = Object.freeze({
    APP_VERSION: '8.6.8', RUNTIME_ENV: 'local-firebase', APP_PUBLIC_URL: 'http://127.0.0.1:8095', STORAGE_MODE: 'firebase', FIREBASE_ENABLED: true, FIREBASE_PLAN: 'spark', ENABLE_CLOUD_FUNCTIONS: false, REQUIRE_AUTH_SERVER_VALIDATION: false, LOCAL_API_ENABLED: false, LOCAL_API_BASE_URL: '', EMAIL_TRANSPORT: 'external-api', WHATSAPP_TRANSPORT: 'manual', EXTERNAL_API_BASE_URL: 'http://127.0.0.1:8097',
