...
function isProductionRuntime(){
  ...
  return runtime==='production'||host.includes('valoragroup.mnsoft.com.br')||host.includes('gestordepesquisa.web.app');
}
function shouldBlockLegacyDemo(row){return isProductionRuntime()&&isLegacyOrDemoRecord(row);}
const isDemoRecord=isLegacyOrDemoRecord;
const isProductionEnvironment=isProductionRuntime;
const isBlockedInProduction=shouldBlockLegacyDemo;
