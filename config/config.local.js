(function () {
  ...
  window.ValoraConfig = Object.freeze({
    APP_VERSION: '8.6.8', RUNTIME_ENV: 'local', APP_PUBLIC_URL: 'http://127.0.0.1:8095', STORAGE_MODE: 'local', FIREBASE_ENABLED: false, FIREBASE_PLAN: 'none', ENABLE_CLOUD_FUNCTIONS: false, REQUIRE_AUTH_SERVER_VALIDATION: false, LOCAL_API_ENABLED: true, LOCAL_API_BASE_URL: '', PUBLIC_SUBMISSION_PROVIDER: 'local', PUBLIC_SURVEY_VALIDATION_PROVIDER: 'local', RESULT_PROVIDER: 'local', EMAIL_TRANSPORT: 'local-outbox', WHATSAPP_TRANSPORT: 'manual', EXTERNAL_API_BASE_URL: '',
