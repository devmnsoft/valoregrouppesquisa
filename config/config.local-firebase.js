(function () {
  ...
  window.ValoraConfig = Object.freeze({
    ...
    API_BASE_URL: 'https://api.valoragroup.mnsoft.com.br', FIREBASE_ENABLED: true, FIREBASE_PLAN: 'spark', ENABLE_CLOUD_FUNCTIONS: false, REQUIRE_AUTH_SERVER_VALIDATION: false, LOCAL_API_ENABLED: false, LOCAL_API_BASE_URL: '', PUBLIC_SUBMISSION_PROVIDER: 'external-api', PUBLIC_SURVEY_VALIDATION_PROVIDER: 'external-api', RESULT_PROVIDER: 'external-api',
