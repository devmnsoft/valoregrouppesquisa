...
const cs=allFiles(['backend'],['.cs']); const sql=allFiles(['backend/database/postgresql'],['.sql']); const js=['app.js','api-client.js','api-repository.js','repository.js','runtime-capabilities.js','gateway-client.js'].map(readIf).join('\n');
